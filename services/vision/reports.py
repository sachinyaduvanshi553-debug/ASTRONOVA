...
"""
    ...
    def generate_evaluation_report(self, eval_results: dict, output_path: str = "evaluation_report.md") -> str:
        out_file = self.output_dir / output_path
...
"""
    ...
    def generate_xai_report(self, xai_results: dict, output_path: str = "xai_report.md") -> str:
        out_file = self.output_dir / output_path

        features = xai_results.get("feature_importances", {})

        md = """# 🧠 AstroNova Vision Explainability Report
...
"""
    ...
    def generate_uncertainty_report(self, uncertainty_stats: dict, output_path: str = "uncertainty_report.md") -> str:
        out_file = self.output_dir / output_path
...
"""
    ...
    def generate_benchmark_report(self, benchmark_results: dict, output_path: str = "benchmark_report.md") -> str:
        out_file = self.output_dir / output_path

        md = """# 🏆 AstroNova Vision Benchmark Report

...
def compute_tss(y_true: Union[List[int], np.ndarray], y_pred: Union[List[int], np.ndarray]) -> float:
    """
...
def compute_hss(y_true: Union[List[int], np.ndarray], y_pred: Union[List[int], np.ndarray]) -> float:
    """
...
def compute_far(y_true: Union[List[int], np.ndarray], y_pred: Union[List[int], np.ndarray], return_ratio: bool = True) -> float:
    """
...
def compute_brier_score(y_true: Union[List[int], np.ndarray], y_prob: Union[List[float], np.ndarray]) -> float:
    """
...
def compute_calibration_error(y_true: Union[List[int], np.ndarray], y_prob: Union[List[float], np.ndarray], n_bins: int = 10) -> float:
    """
...
def compute_reliability_curve(y_true: Union[List[int], np.ndarray], y_prob: Union[List[float], np.ndarray], n_bins: int = 10) -> Dict[str, List[float]]:
    """
...
def compute_roc_curve(y_true: Union[List[int], np.ndarray], y_prob: Union[List[float], np.ndarray]) -> Dict[str, Any]:
    """
...
def compute_pr_curve(y_true: Union[List[int], np.ndarray], y_prob: Union[List[float], np.ndarray]) -> Dict[str, Any]:
    """
...
def generate_confusion_matrix(y_true: Union[List[int], np.ndarray], y_pred: Union[List[int], np.ndarray]) -> Dict[str, int]:
    """

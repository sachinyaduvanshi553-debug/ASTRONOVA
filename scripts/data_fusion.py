...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--solexs-file",
        type=str,
        default="data/sample/clean_solexs.parquet",
        help="Path to clean SoLEXS Parquet.",
    )
    parser.add_argument(
        "--helios-file",
        type=str,
        default="data/sample/clean_helios.parquet",
        help="Path to clean HEL1OS Parquet.",
    )
    parser.add_argument(
        "--output-file",
        type=str,
        default="data/sample/aditya_fusion_dataset.parquet",
        help="Path to save fused Parquet file.",
    )
